	...
	public sealed partial class NewGamePage : Page
	{
		...
		public NewGamePage()
		{
			...
			var question = new string[] {
				"당신이 한밤중에 공부하고 있을 때 밖에서 무슨 소리가 들렸다",
				"당신이 한 시골에서 버스를 타고 가던 중 깊 앞을 막고 쓰러져 있는 나무 때문에 버스가 지나갈 수 없게 되었다."
			};
			...
			var answer = new string[][] {
				...
				new string[] {
					"1] 버스에서 내려 나무를 치운다",
					"2] 남이 치울 거라 생각하며 기다린다",
					"3] 버스 안에서 나무를 치울 방법을 궁리한다'"
				}
			};
			...
			question = new string[] {
				...
				"당신은 큰 죄를 지은 결과로 지금 사형집행을 당하게 되었다"
			};

			answer = new string[][] {
				new string[] {
					"1] 힘이 남아있는 한 죽을 때까지 싸운다",
			...
			question = new string[] {
				"당신은 매우 복잡한 매듭을 풀어야 하는 일이 생겼다",
				"당신이 이 게임 속에서 벌이는 활약상은?"
			};
			...
			question = new string[] {
				"허허벌판을 걸어가던 당신은 갑작스러운 우박을 만난다",
				"당신은 해발 5,000m 가 넘는 고지에서 눈사태 때문에 고립되었다. 구조대가 오려면 12시간. 그동안 당신은 어떻게 하겠는가?"
			};
			...
			question = new string[] {
				"집안에 불이 나서 탈출하려는데 나무로 만든 문이 좀처럼 열리지 않는다",
				"당신은 사막을 여행 중이다. 오아시스까지는 앞으로 1km, 당신의 행동은?"
			};

			answer = new string[][] {
				new string[] {
					"1] 다른 탈출구를 찾아간다",
					"2] 1] 번과 같은 불확실한 도전을 하는 것보다는 확실한 탈출구인 이 문을 끝까지 열려 한다",
					"3] 나무 문이 타서 구멍이 생길 때까지 기다려 탈출한다"
				},
				new string[] {
					"1] 체력을 소모해서라도 좀 더 빨리 걸음을 재촉한다",
					"2] 여태껏 걸어왔던 것처럼 꿋꿋하게 간다",
					"3] 당신은 원래 더위를 타지 않아서 빨리 갈 필요가 없다"
				}
			};
			...
			question = new string[] {
				"고대에 태어난 당신은, 한날 당신의 눈앞에서 물체가 사라지는 마술을 보았을 때 당신의 해석은?",
				"이 게임 속에서는 당신이 주인공이며 전능해질 수 있다. 그렇다면 지금 당신 앞에 있는 수많은 괴물들을 어떻게 처리하겠는가?"
			};
			...
			answer = new string[][] {
				...
				new string[] {
					"1] 남극의 브리자드를 불러와서 화염을 무력화시킨다",
					"2] 당신 앞의 땅이 솟아오르게 하여 화염을 차단시킨다",
			...
			question = new string[] {
				"직장 생활을 하던 당신은 아무 이유 없이 상관에게 심한 욕을 들었다",
				"당신은 게임 속에서 거대한 악마를 만났다. 당신은 혼자뿐이고 이길 승산은 희박했다. 어떻게 할 것인가?"
			};
			...
			question = new string[] {
				"당신이 새로운 프로그램을 짜던 중 알 수 없는 오류가 생겼다",
				"지금은 당신의 국민학교 1학년 시절. 산수 시험 문제지를 받고 보니 앞이 깜깜했다. 당신은 어떻게 하겠는가?"
			};
