...
namespace MysticUWP
{
	...
	public sealed partial class MainPage : Page
	{
		...
		private static string[] characters = new string[]
		{
			" 오래전부터 만날 운명이었던 당신에게.",
			"",
			" 나는 시공의 여행자인 타임워커 알비레오라고 하오. 내가 로어 세계가",
			"있는 공간으로 접어들었을 때 마침 이 세계는 로드 안의 통치에 있었소.",
			" 그때 내가 그대들에게 닥쳐 올 불확실한 미래를 나의 다섯 가지",
			"예언으로 계시해 주었던 것을 기억할 거요. 그리고 그 예언이 너무나도",
			"큰 희생을 강요했던 것도 기억하고 있을 거라 믿소. 나는 세상을 구하기",
			"위해 자신을 희생해야만 했던 그를 이해하오.",
			"또한 숙명의 적이었던 네크로만서와 불멸의 다크메이지 실리안 카미너스",
			"역시 나는 용서할 수 있었소. 하지만 그들을 용서하는 데에는 대단한",
			"용기를 감수해야만 했다오. 그들의 진심을 이해하기 위해 나는 서둘러",
			"로어 세계의 과거로 도약을 시작했고 거기서 내가 보았던 것은",
			"네크로만서와 다크메이지의 계획된 탄생이었소. 내가 그 계기로 진정한",
			"이 세계의 진실을 알게 되었을 때, 나 스스로가 이 세계에 대한 경멸로",
			"마음을 닫아 버렸소. 그래서 나를 이해할 수 있을 것 같은 당신에게",
			"이렇게 도움을 청하는 거요. 당신이 네크로만서와 다크메이지를 완전히",
			"소멸 시키는 그날, 이 세계는 다시 원래의 운명의 궤도로 접어들게",
			"되고 나는 그때야 비로소 다른 공간으로의 여행을 다시 시작하게 될 거요.",
			"",
			"                                     타임워커 알비레오로부터",
		};
	}
