...
namespace MysticUWP
{
	...
	public sealed partial class Ending2 : Page
	{
		...
		private static string[] characters = new string[]
		{
			" 새로운 로드 안이 된 당신에게..",
			"",
			" 역시 당신은 나의 기대를 저버리지 않았소. 나 알비레오는 그저 로어",
			"세계의 역사에 대해 방관자적인 입장일 뿐이었지만 비뚤어져가는",
			"로어 세계의 미래를 그냥 보고만 있을 수는 없어서 당신을 선택하게",
			"되었고 당신을 이런 모험에 말려들게 했던 것이오. 이제 위선자는",
			"사라졌고 로드 안의 칭호도 당신에게 돌아갔소. 하지만 당신에게는",
			"아직 2가지의 과제가 더 남아있소. 첫째는 네크로만서가 된 카노푸스가",
			"이 땅에 내려올 때 벌어지게 되고 둘째는 멸망당한 네 종족의 원혼이",
			"부활할 때 발생하게 될 거요. 이 일들은 약 100년 후에 발생할",
			"것이오. 하지만 당신이라면 충분히 이겨낼 수 있을 거라 믿소.",
			"",
			" 나는 이제 이 세계를 떠날 때가 되었소. 아직도 내가 가보아야 할",
			"차원이 수없이 많이 있기 때문이오. 로어 세계가 있는 이곳도 그저",
			"내가 스쳐갔던 수많은 차원들 중의 하나로 기억될지도 모르겠지만",
			"쉽게 잊어버리기에는 너무 아까운 기억이 많이 있소. 그중의 하나는",
			"당신의 존재 때문일 거라오. 이제 나는 이곳 역사에 더 이상 신경을",
			"쓰지 않으려고 하오. 앞으로 다시 올 계획도 아직은 없소. 그저 영원의",
			"차원으로 나의 여행을 계속할 뿐이라오.",
			"",
			"                                    타임워커 알비레오로부터.",
		};
	}
